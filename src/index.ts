interface DayContent {
 ...
 const days: DayContent[] = [
  ...
  { image: "assets/santahat.jpeg", 
    ...
    things you can do to land yourself on the naughty list, including exercising morning yoga and not reading books that your lovely girlfriend gifted you for Christmas.`,
